    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCc3ktJXzCcNfEo8q5t2lVAg?app=1')
                time.sleep(2)
                menu()
